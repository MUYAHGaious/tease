...
class AgencySelectionScreen extends StatefulWidget {
  ...
  @override
  State<AgencySelectionScreen> createState() =>
      _AgencySelectionScreenState();
}
...
class _AgencySelectionScreenState extends State<AgencySelectionScreen>
  ...
  String _currentText = 'Choose your agency';
  bool _isLoading = false;
  bool _isDarkMode = false;
  late AdaptiveThemeManager _themeManager;

  final List<Map<String, dynamic>> _agencyOptions = [
    {
      'id': 'moghamo',
      'title': 'Moghamo',
      'icon': Icons.business,
  ...
  void _proceedToNextStep() {
    ...
    if (_selectedAgency != null) {
      Navigator.pushNamed(context, '/role-selection', arguments: _selectedAgency);
    }
  }
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 1.h),
                      Text(
                        'Select the agency you are affiliated with.',
                        style: TextStyle(
                      ...
                      GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return _buildAgencyCard(option, isSelected);
                        },
                      ),
                      SizedBox(height: 3.h),
                      AnimatedBuilder(
                            ...
                            child: Transform.translate(
                              ...
                              child: Container(
                                ...
                                child: ElevatedButton(
                                  onPressed: _selectedAgency != null
                                      ? _proceedToNextStep
                                      : null,
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor: _buttonBackgroundColor(context),
