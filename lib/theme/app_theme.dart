...
/// A class that contains all theme configurations for the bus ticket booking application.
/// Implements Contemporary Spatial Minimalism with Sophisticated Earth Gradient color scheme.
class AppTheme {
  AppTheme._();
  ...
  static const Color errorLight = Color(0xFFd93025); // Google-standard red
  static const Color onPrimaryLight = Color(0xFFffffff); // White on primary
  static const Color onSecondaryLight =
      Color(0xFF202124); // Dark gray on secondary
  static const Color onBackgroundLight =
      Color(0xFF202124); // Dark gray on background
  ...
  static const Color onSurfaceVariantDark =
      Color(0xFFa0a0a0); // Light gray variant
  static const Color onErrorDark = Color(0xFF000000); // Black on error

  // Glassmorphism and elevation colors
  ...
  // Shadow colors for glassmorphism effects
  static const Color shadowLight = Color(0x1A000000); // 0.1 opacity black
  static const Color shadowDark = Color(0x1A000000); // Consistent shadow

  // Divider colors
  static const Color dividerLight = surfaceVariantLight;
  static const Color dividerDark = surfaceVariantDark;

  // Text emphasis colors for mobile readability
  static const Color textHighEmphasisLight = Color(0xFF202124); // Primary text
  static const Color textMediumEmphasisLight =
      Color(0xFF5f6368); // Secondary text
  static const Color textDisabledLight = Color(0xFF9aa0a6); // Disabled text

  static const Color textHighEmphasisDark =
      Color(0xFFffffff); // Primary text dark
  static const Color textMediumEmphasisDark =
      Color(0xFFa0a0a0); // Secondary text dark
  static const Color textDisabledDark = Color(0xFF6c6c6c); // Disabled text dark

  /// Light theme with Contemporary Spatial Minimalism design
  static ThemeData lightTheme = ThemeData(
    ...
    // AppBar with glassmorphism-ready styling
    ...
    // Card theme optimized for glassmorphism effects
    ...
    // FAB with physics-based micro-interactions ready
    ...
    // Button themes with trust-building design
    ...
    // Input decoration for trust-building forms
    inputDecorationTheme: InputDecorationTheme(
      ...
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(8.0),
        borderSide: const BorderSide(color: surfaceVariantLight, width: 1),
      ),
    ...
    checkboxTheme: CheckboxThemeData(
      ...
      side: const BorderSide(color: surfaceVariantLight, width: 2),
      shape: RoundedRectangleBorder(
    ...
    // Dialog theme for premium interactions
  ...
  /// Dark theme with Contemporary Spatial Minimalism design
  static ThemeData darkTheme = ThemeData(
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(8.0),
        borderSide: const BorderSide(color: surfaceVariantDark, width: 1),
      ),
      enabledBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(8.0),
        borderSide: const BorderSide(color: surfaceVariantDark, width: 1),
    ...
    checkboxTheme: CheckboxThemeData(
      ...
      side: const BorderSide(color: surfaceVariantDark, width: 2),
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(2),
      ),
    ),
  ...
  /// Helper method for data text style
  ...
  /// Optimized for mobile readability and Contemporary Spatial Minimalism
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      headlineSmall: GoogleFonts.inter(
        fontSize: 24,
        fontWeight: FontWeight.w500, // Medium for mobile scanning
        color: textHighEmphasis,
        letterSpacing: 0,
        height: 1.33,
      ),
      ...
      titleLarge: GoogleFonts.inter(
        fontSize: 22,
        fontWeight: FontWeight.w500, // Medium for mobile readability
        color: textHighEmphasis,
        letterSpacing: 0,
        height: 1.27,
      ),
      titleMedium: GoogleFonts.inter(
        fontSize: 16,
        fontWeight: FontWeight.w500, // Medium for component titles
        color: textHighEmphasis,
        letterSpacing: 0.15,
        height: 1.50,
      ),
