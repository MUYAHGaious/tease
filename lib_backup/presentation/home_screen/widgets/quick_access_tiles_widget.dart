...
class _QuickAccessTilesWidgetState extends State<QuickAccessTilesWidget>
  ...
  final List<Map<String, dynamic>> _quickAccessTiles = [
    {
      ...
      'route': AppRoutes.myBookingsScreen,
    },
    {
      'title': 'Live Tracking',
  ...
  Widget _buildTileSubtitle(Map<String, dynamic> tile, int index) {
    String subtitle;
    Color subtitleColor = AppTheme.lightTheme.colorScheme.onSurfaceVariant;
    ...
    switch (index) {
      ...
      case 2: // Wallet Balance
        subtitle = '\$47.50 available';
        subtitleColor = AppTheme.lightTheme.colorScheme.secondary;
        break;
  ...
  Widget _buildSupportOption(IconData icon, String text) {
    return Row(
      children: [
        Icon(icon, color: AppTheme.lightTheme.colorScheme.primary, size: 5.w),
        SizedBox(width: 2.w),
        Expanded(
          child: Text(
            text,
