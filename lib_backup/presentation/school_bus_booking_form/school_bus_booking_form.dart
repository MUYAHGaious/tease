...
class SchoolBusBookingForm extends StatefulWidget {
  const SchoolBusBookingForm({Key? key}) : super(key: key);

  @override
  State<SchoolBusBookingForm> createState() => _SchoolBusBookingFormState();
}

class _SchoolBusBookingFormState extends State<SchoolBusBookingForm> {
  ...
  // ICT University Campus Routes
  final List<Map<String, dynamic>> _mockRoutes = [
    {
      "id": "route_001",
      "name": "ICT Main Campus Route",
      "pickupStops": [
        "ICT University Main Gate",
        "Student Residence - Block A",
        "Student Residence - Block B",
        "Staff Quarters",
        "ICT Shopping Complex"
      ],
      "dropOffStops": [
        "ICT Administration Block",
        "ICT Computer Science Building",
        "ICT Engineering Faculty",
        "ICT Library & Learning Center",
        "ICT Student Center"
      ]
    },
    {
      "id": "route_002",
      "name": "ICT City Campus Route",
      "pickupStops": [
        "Douala Central Station",
        "Bonaberi Junction",
        "Deido Commercial Area",
      ...
      builder: (context, child) {
        return DatePickerTheme(
          data: DatePickerThemeData(
            ...
            headerBackgroundColor: const Color(0xFF1B4D3E),
        ...
        builder: (context) => AlertDialog(
          ...
          actions: [
            TextButton(
              ...
              child: Text(
                'Stay',
                style: TextStyle(color: const Color(0xFF1B4D3E)),
              ),
            ),
            TextButton(
          ...
          children: [
            ...
            SafeArea(
              child: ICTUniversityNav(
                currentIndex: 1, // Book Ride tab
                onTap: (index) {
                  _navController.updateIndex(1);
                  _navController.navigateToIndex(context, index);
                },
              ),
            ),
          ],
